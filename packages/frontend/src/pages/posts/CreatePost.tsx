...
import { BlogCreateRequest } from '../../services/posts/types';
...
}: {isAuthenticated: boolean; authState: AuthState}_) => {
        ...
        <div className="card">
            ...
            {isAuthenticated && (
                <h4>
                    ...
                    <Link to={encodeURI("/posts/user/${authState.user?.username}")}> here
                    </Link>{" "}
                    too!
                </h4>
            )}
